...
- **Framework repo (this repo):** docker-compose stack (hub supervisor, Postgres, dashboard, LiteLLM) + spokes (runners) that join by pulling work over HTTP+SSE. `git clone && docker-compose up` bootstraps the lab.
